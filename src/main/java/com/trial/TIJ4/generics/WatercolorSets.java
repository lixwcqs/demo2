package com.trial.TIJ4.generics;//: generics/WatercolorSets.java

import com.trial.TIJ4.generics.watercolors.Watercolors;

import java.util.EnumSet;
import java.util.Set;

import static com.trial.TIJ4.generics.watercolors.Watercolors.*;
